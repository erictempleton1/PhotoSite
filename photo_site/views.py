...
def user_page(request, username):
                    ...
                    if filename_exists is False:
                        ...
                        try:
                            ...
                            image_cloudfront = '{0}{1}'.format(settings.CLOUDFRONT_URL,
                                                last_upload.image.url.split('?')[0][50:])

                            thumbnail_cloudfront = '{0}{1}'.format(settings.CLOUDFRONT_URL,
                                                    last_upload.thumbnail.url.split('?')[0][50:])
    ...
    context = {'file_form': file_form, 'username': username,
                'url_form': url_form, 'user_images': user_images}
